KM.UI.Unit.Android = KM.UI.Unit.extend({
    ...
    _drawBody: function()
    {
        ...
        androidBody.path("m12.947,29.344,0,35.893c0,1.7807,2.1523,4.1116,3.933,4.1116h5.6295v12.237c0,3.1162,2.2691,5.625,5.0938,5.625,2.8246,0,5.0938-2.5088,5.0938-5.625v-12.237h8.1875v12.237c0,3.1162,2.2691,5.625,5.0938,5.625,2.8246,0,5.125-2.5088,5.125-5.625v-12.237h5.5982c1.7807,0,3.933-2.3309,3.933-4.1116v-35.893h-47.688z").translate(this.OFFSET_X, this.OFFSET_Y);
        androidBody.rect(0,     28.593, 10.197, 32.545, 5.625).translate(this.OFFSET_X, this.OFFSET_Y);
        androidBody.rect(63.39, 28.593, 10.197, 32.545, 5.625).translate(this.OFFSET_X, this.OFFSET_Y);
