/*
    ...
    -   If you want to use these algorithms for instances of class A
        ...
        -   Call JW.apply(A.prototype, JW.Alg.BuildMethods)
*/
...
JW.apply(JW, {
    ...
    /**
     * Finds all item objects which contain method returning result equal (==)
     * to specified value and builds new collection of such items.
     * This collection must contain objects only.
     */
...
JW.Alg.BuildMethods = {
    ...
    filterByMethod: function(method, args, value)
    {
        return JW.filterByMethod(this, method, args, value);
    },
